...
/**
 * Spring controller to handle HTTPS requests related to the RESTful web service associated to user/app registration service in
 * Cloud AAM component.
 *
...
//    public class handleCustomAAMException{
//        @ExceptionHandler(CustomAAMException.class)
//        public ResponseEntity<ErrorResponseContainer> handleException(CustomAAMException e) {
